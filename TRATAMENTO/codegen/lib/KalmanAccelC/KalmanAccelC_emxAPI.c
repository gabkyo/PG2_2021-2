...
/*
 * Arguments    : table emxArray
 * Return Type  : void
 */
void emxDestroy_table(table emxArray)
{
  emxFreeStruct_table(&emxArray);
}
 ...
 * Return Type  : void
 */
void emxInit_table(table *pStruct)
{
  emxInitStruct_table(pStruct);
}

/*
 * File trailer for KalmanAccelC_emxAPI.c
 *
 * [EOF]
 */
